...
TASK_GUIDANCE = {
    ...
    "KP_Stage": {
        "goal": "根据学生历史题目与表现，选择最匹配当前教学章节 / 知识阶段的候选题。",
        "basis": ["重点判断候选题是否符合历史题目出现的主要教学章节。", "无需关注难度高低。", "明显过早或过晚的题不应优先推荐。"],
    },
    "Planning_Progress": {
    ...
    "Planning_Target": {
        ...
        "basis": ["显式学习目标是核心条件。", "候选题应真正服务学习目标。", "无需关注难度"],
    },
...
TEACHER_TASK_GUIDANCE = {
    ...
    "Congnition": {
        ...
        "basis": [
            ...
            "判断时，请综合历史题的认知要求与作答结果，关注学生当前尚未稳定掌握、但已经表现出一定完成能力的认知层级。",
